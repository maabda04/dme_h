...
export const metadata: Metadata = {
  title: "About DME Billing | Expert Medical Billing Team & Company History",
  description: "Learn about DME Billing's expert team, mission, and proven track record in medical billing and revenue cycle management. 15+ years serving healthcare providers nationwide.",
  keywords: "about DME billing, medical billing company, healthcare billing experts, revenue cycle management team, medical billing experience",
  alternates: {
          ...
          <div className="mx-auto max-w-4xl rounded-2xl bg-gradient-to-r from-primary/90 to-primary-dark p-12 shadow-xl relative overflow-hidden">
            ...
            <div className="text-center relative z-10">
              ...
              <p className="mt-4 text-xl text-white/90 max-w-2xl mx-auto">
                Join hundreds of healthcare providers who trust DME Healthcare Billing with their revenue cycle management.
              </p>
              <div className="mt-10">
                <Link 
                  href="/get-started" 
