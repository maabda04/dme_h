...
export const metadata: Metadata = {
  title: "DME Billing | Medical Billing & Revenue Cycle Management",
  description: "DME Billing provides comprehensive medical billing services, revenue cycle management, credentialing, and healthcare billing solutions for providers.",
  keywords: "medical billing, revenue cycle management, provider credentialing, healthcare billing, medical practice management",
  authors: [{ name: "DME Billing" }],
  creator: "DME Billing",
  publisher: "DME Billing",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  ...
  openGraph: {
    ...
    siteName: "DME Billing",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "DME Billing - Medical Billing Services",
      },
    ],
    locale: "en_US",
    type: "website",
...
const structuredData = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      name: "DME Billing",
      alternateName: "DME Healthcare Services",
      url: "https://bhshealthcares.com",
      logo: {
        "@type": "ImageObject",
        url: "https://bhshealthcares.com/DME-LOGO.png",
        width: 180,
        height: 40,
      },
      image: "https://bhshealthcares.com/DME-LOGO.png",
      description: "DME Billing provides comprehensive medical billing services, revenue cycle management, provider credentialing, and healthcare billing solutions for providers.",
      contactPoint: {
        "@type": "ContactPoint",
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <head>
        ...
        <link rel="preload" href="/DME-LOGO.png" as="image" type="image/png" />
        <script
