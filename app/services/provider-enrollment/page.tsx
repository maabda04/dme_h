...
export default function ProviderEnrollmentPage() {
  ...
  const testimonials = [
    {
      quote: "DME transformed our provider enrollment process. What used to take months now takes weeks, and our approval rate has improved significantly.",
      author: "Dr. Michael Reynolds",
      role: "Medical Director, Westside Medical Group"
    },
    {
      quote: "The expertise of the DME team in navigating the complex credentialing process has been invaluable to our practice's growth and financial stability.",
