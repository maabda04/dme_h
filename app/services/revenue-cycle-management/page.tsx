...
export default function RevenueCycleManagementPage() {
  ...
  const testimonials = [
    {
      quote: "DME has transformed our revenue cycle management. Our clean claims rate has improved by 15% and days in A/R reduced by 30%.",
      
      role: "Medical Director, Washington, D.C."
    },
    {
      quote: "The expertise and dedication of the DME team has significantly improved our financial performance and allowed us to focus on patient care.",
                  ...
                  {testimonials.map((testimonial, index) => (
                    <div key={index} className="bg-gray-50 p-6 rounded-xl relative">
                      ...
                      <div className="flex space-x-1 mb-4 ml-6">
                        {[...Array(5)].map((_, i) => (
                          <svg key={i} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#1e3a8a" className="text-primary">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6 relative">
                      ...
                      <p className="text-gray-700 italic mb-4">
                        "DME transformed our revenue cycle. Our clean claims rate improved by 15% and days in A/R reduced by 30%."
                      </p>
