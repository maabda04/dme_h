    ...
    try {
      const response = await fetch('https://chat.reveraforte.com/bhs.php', {
        ...
        body: JSON.stringify({
          ...
          source: 'DME Website Contact Form'
        }),
      })
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="w-[95vw] max-w-[900px] h-[85vh] max-h-[85vh] overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50/30 border-0 shadow-2xl p-0 rounded-xl sm:rounded-2xl">
        <DialogHeader className="sr-only">
          <DialogTitle>Contact DME Healthcare Services</DialogTitle>
        </DialogHeader>
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        required
                        className={`pl-10 h-12 sm:h-10 bg-gray-50/50 transition-all duration-200 rounded-xl text-gray-900 placeholder:text-gray-400 text-base sm:text-sm ${
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        required
                        className={`pl-10 h-12 sm:h-10 bg-gray-50/50 transition-all duration-200 rounded-xl text-gray-900 placeholder:text-gray-400 text-base sm:text-sm ${
                          (validationErrors.some(error => error.includes('Email') || error.includes('email')) || !isEmailValid(formData.email))
                            ? 'border-red-300 focus:border-red-500 focus:ring-2 focus:ring-red-200'
                            : 'border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20'
                        }`}
                      />
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      required
                      className={`pl-10 h-12 sm:h-10 bg-gray-50/50 transition-all duration-200 rounded-xl text-gray-900 placeholder:text-gray-400 text-base sm:text-sm ${
                        validationErrors.some(error => error.includes('Subject'))
                          ? 'border-red-300 focus:border-red-500 focus:ring-2 focus:ring-red-200'
                          : 'border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20'
                      }`}
                    />
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    <Textarea
                      ...
                      required
                      rows={3}
                      className={`pl-10 pt-3 pb-3 bg-gray-50/50 transition-all duration-200 rounded-xl text-gray-900 placeholder:text-gray-400 resize-none text-base sm:text-sm ${
                        validationErrors.some(error => error.includes('Message'))
                          ? 'border-red-300 focus:border-red-500 focus:ring-2 focus:ring-red-200'
                          : 'border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20'
                      }`}
                    />
              ...
              <form onSubmit={handleSubmit}>
                <div className="flex flex-col gap-2 sm:gap-3">
                  {submitStatus === 'success' && (
                    <div className="flex items-center justify-center p-3 bg-green-50 border border-green-200 rounded-xl text-green-800 text-sm">
                      <CheckCircle className="h-4 w-4 mr-2" />
                      Message sent successfully! We'll get back to you soon.
                    </div>
                  )}
                  {submitStatus === 'error' && (
                    <div className="flex items-center justify-center p-3 bg-red-50 border border-red-200 rounded-xl text-red-800 text-sm">
                  ...
                  <Button
                    ...
                    className={`w-full h-12 sm:h-11 font-semibold transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl shadow-lg rounded-xl text-base sm:text-sm ${
                      submitStatus === 'success'
