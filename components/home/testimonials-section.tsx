...
const testimonials = [
  {
    content:
      "DME Healthcare Billing transformed our practice's financial performance. Their team helped us increase our collections by 32% in just six months while reducing our administrative workload.",
  ...
  {
    content:
      "As a busy OB/GYN practice, we needed a billing partner who understood our specialty. DME Healthcare Billing's expertise has been invaluable, and their team is responsive and professional.",
  ...
  {
    content:
      "Switching to DME Healthcare Billing was the best decision we made for our pediatric practice. Their attention to detail and knowledge of pediatric billing codes has significantly improved our reimbursement rates.",
      ...
      <div className="container">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-lg text-neutral-600">
            Hear from healthcare providers who have transformed their billing processes with DME Healthcare Billing.
          </p>
        </div>
